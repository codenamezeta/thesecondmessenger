    ...
    >
      <div className="flex rounded-none border border-border/50 bg-background/40 backdrop-blur-sm">
        <button
          ...
          className={cn(
            'inline-flex min-h-12 flex-1 items-center justify-center gap-2 border-border/50 border-r px-4 font-mono text-xs tracking-wider uppercase transition-colors sm:min-w-26 sm:flex-none',
            resolvedTheme === 'light'
