...
const STEPS = [
  {
    ...
    subtitle: 'Hit play.',
    body: 'No algorithm. No playlist loop. Just a direct transmission from the source. Press play on any track and let the architecture speak for itself.',
  ...
  },
  {
    ...
    subtitle: 'Subscribe.',
    body: "Subscribe on YouTube to get every new transmission the moment it drops. You're not following a brand — you're joining a community that shapes what comes next.",
    cta: {
